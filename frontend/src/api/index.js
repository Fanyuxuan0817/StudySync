...
const api = {
  ...
  chatRooms: {
    ...
    removeMember: (chatRoomId, userId) => apiClient.delete(`/chat-rooms/${chatRoomId}/members/${userId}`),
    updateMemberRole: (chatRoomId, userId, role) => apiClient.put(`/chat-rooms/${chatRoomId}/members/${userId}/role`, { role }),
